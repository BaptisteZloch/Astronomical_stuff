namespace Test_ASCOM_form
{
    partial class Global_handling
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.focuser_temp_timer = new System.Windows.Forms.Timer(this.components);
            this.ccd_temp_timer = new System.Windows.Forms.Timer(this.components);
            this.FW_position_timer = new System.Windows.Forms.Timer(this.components);
            this.exposure_backworker = new System.ComponentModel.BackgroundWorker();
            this.exposure_progressbar = new System.Windows.Forms.ProgressBar();
            ...
            // groupBox2
            // 
            this.groupBox2.Controls.Add(this.exposure_progressbar);
            ...
            // filter_select
            // 
            this.filter_select.Enabled = false;
            ...
            this.filter_select.SelectedIndexChanged += new System.EventHandler(this.filter_select_SelectedIndexChanged);
            // 
            // filter_wheel_choose
            // 
            ...
            // focuser_temp_timer
            // 
            this.focuser_temp_timer.Interval = 600;
            this.focuser_temp_timer.Tick += new System.EventHandler(this.focuser_temp_timer_Tick);
            // 
            // ccd_temp_timer
            // 
            this.ccd_temp_timer.Interval = 600;
            this.ccd_temp_timer.Tick += new System.EventHandler(this.CCD_temp_timer_Tick);
            // 
            // FW_position_timer
            // 
            this.FW_position_timer.Interval = 1000;
            this.FW_position_timer.Tick += new System.EventHandler(this.FW_temp_timer_Tick);
            // 
            // exposure_backworker
            // 
            this.exposure_backworker.WorkerReportsProgress = true;
            this.exposure_backworker.WorkerSupportsCancellation = true;
            this.exposure_backworker.DoWork += new System.ComponentModel.DoWorkEventHandler(this.exposure_backworker_DoWork);
            this.exposure_backworker.ProgressChanged += new System.ComponentModel.ProgressChangedEventHandler(this.exposure_backworker_ProgressChanged);
            this.exposure_backworker.RunWorkerCompleted += new System.ComponentModel.RunWorkerCompletedEventHandler(this.exposure_backworker_RunWorkerCompleted);
            // 
            // exposure_progressbar
            // 
            this.exposure_progressbar.Location = new System.Drawing.Point(43, 209);
            this.exposure_progressbar.Name = "exposure_progressbar";
            this.exposure_progressbar.Size = new System.Drawing.Size(198, 10);
            this.exposure_progressbar.TabIndex = 30;
            // 
            // display_image
            // 
            this.display_image.Location = new System.Drawing.Point(493, 39);
            this.display_image.Name = "display_image";
            this.display_image.Size = new System.Drawing.Size(413, 269);
            this.display_image.TabIndex = 11;
        ...
        private System.Windows.Forms.Timer focuser_temp_timer;
        private System.Windows.Forms.Timer ccd_temp_timer;
        private System.Windows.Forms.Timer FW_position_timer;
        private System.ComponentModel.BackgroundWorker exposure_backworker;
        private System.Windows.Forms.ProgressBar exposure_progressbar;
